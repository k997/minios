...
gcc -m32 -fno-builtin -fno-stack-protector -I $LIB -I $LIB/kernel -c -o $OUTPUT/interrupt.o $KERNEL/interrupt/interrupt.c &&\
...
ld -m elf_i386 -Ttext 0xc0001500 -e main -o $OUTPUT/kernel.bin \
   $OUTPUT/main.o $OUTPUT/print.o  $OUTPUT/interrupt_asm.o $OUTPUT/interrupt.o $OUTPUT/init.o  && \
